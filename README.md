...
### SignUp
Un formulaire d'inscription moderne avec validation en temps réel.
- `Signup.html` - Structure du formulaire
- `Signup.css` - Styles personnalisés
- `Signup.js` - Logique de validation et d'interaction

### slider_image
Un composant de diaporama d'images réactif.
- `index.html` - Structure du slider
...
Chaque dossier contient un projet indépendant. Ouvrez simplement le fichier `index.html` correspondant dans votre navigateur pour voir le résultat.
